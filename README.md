...
| ---------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| Windows          | [Zakkir-Setup-1.2.2.exe](https://github.com/mohamedsameh20/Zakkir/releases/download/v1.2.2/Zakkir-Setup-1.2.2.exe)                 | Run the installer                                           |
| Debian / Ubuntu  | [zakkir-desktop_1.2.2_amd64.deb](https://github.com/mohamedsameh20/Zakkir/releases/download/v1.2.2/zakkir-desktop_1.2.2_amd64.deb) | `sudo dpkg -i zakkir-desktop_1.2.2_amd64.deb`               |
| Linux (AppImage) | [Zakkir-1.2.2.AppImage](https://github.com/mohamedsameh20/Zakkir/releases/download/v1.2.2/Zakkir-1.2.2.AppImage)                   | `chmod +x Zakkir-1.2.2.AppImage && ./Zakkir-1.2.2.AppImage` |
