...
pkgs.stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    cp -r package.json popup.html popup.js popup.css azkar.json icon.png icon_16.png icon_48.png main.js notification-scheduler.js preload.js leaflet sounds fonts $out/share/zakkir-desktop/
